...
def LoadData(): #载入训练数据集
    ...
    label = []
    num = 100
    path_cwd = "/Users/gaoyue/文档/研究生课程/2015冬季学期/计算机模式识别/project/face_recognition_v1.0/train/"
    for j in range(1, 4):
...
if __name__ == '__main__':
    ...
    #人脸识别分类器本地存储路径
    cascade_path = "/Users/gaoyue/文档/研究生课程/2015冬季学期/计算机模式识别/project/opencv/sources/data/haarcascades/haarcascade_frontalface_alt.xml"
